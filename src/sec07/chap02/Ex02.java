...
/*
* 박싱과 언박싱
* 원시값을 래퍼 클래스의 인스턴스로 boxing - 토니가 슈트를 입음
* 래퍼 클래스의 인스턴스를 윈시값으로 unboxing - 토니가 슈트를 벗음
*/
...
public class Ex02 {
    public static void main(String[] args) {
        ...
        int intPrim1 = 123;
        Integer intInst = Integer.valueOf(intPrim1);
        ...
        *   - 성능상으로는 떨어지므로 자주 사용하지는 (특히, 반복문 안에서) 말 것
        */
